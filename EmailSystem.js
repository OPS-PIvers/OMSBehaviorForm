...
function onOpen() {
  ...
  ui.createMenu('Behavior System')
    ...
    .addSeparator()
    .addSubMenu(ui.createMenu('Device Infractions')
      .addItem('Quarter Dates & Alert Settings', 'showDeviceInfractionSettings')
      .addItem('Recount Now', 'recountDeviceInfractionsFromMenu')
      .addItem('Send Test Alert to Me', 'sendTestDeviceInfractionDigest')
      .addSeparator()
      .addItem('Turn On Daily Alert (3 PM)', 'turnOnDeviceInfractionAlerts')
      .addItem('Turn Off Daily Alert', 'turnOffDeviceInfractionAlerts')
    )
